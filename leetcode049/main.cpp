...
public:
    ...
    bool same(map<char, int>& m, string& str)
    {
        ...
        for (iter2 = mcopy.begin(); iter2 != mcopy.end(); iter2++)
        {
            if ((*iter2).second == 0)
            {
                continue;
